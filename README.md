...
Plánované funkce
(Všechny naplánované funkce byly implementovány)
...
Backend používá DI Container (PHP-DI) a vrstvení:
Controller → Service → Repository.

Frontend je rozdělen na:
...
Nebo pokud již máte soubor `data/raw/parcels.geojson`, spusťte import ručně:
